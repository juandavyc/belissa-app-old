...
$method = isset($_GET['m']) ? $_GET['m'] . 'vehiculo' : 'error';
...
if (
    ...
    if ($database->estadoConexion()['status']) {
        ...
        $vehiculoModelo = new VehiculoModelo($database->getPDO(), $config);
        // var_dump($method);
        $vehiculoModelo->$method();
    } else {
...
class VehiculoModelo
{
    ...
    public function Listadovehiculo()
    {
        ...
        require_once DOCUMENT_ROOT . '/modulos/app/modelo/vehiculo/vehiculo.listado.php';
    ...
    {
        require_once DOCUMENT_ROOT . '/modulos/app/modelo/vehiculo/vehiculo.informacion.php';
        $this->configuracion->petResponse($this->arrayResponse);
    }

    public function Updatevehiculo()
    {
        require_once DOCUMENT_ROOT . '/modulos/app/modelo/vehiculo/vehiculo.actualizar.php';
        $this->configuracion->petResponse($this->arrayResponse);
    }
