export function fun_tarifa_submit() {
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url:
            PROTOCOL_HOST +
            '/modulos/app/modelo/tarifa/tarifa.modelo.php?m=Tab',
          type: "POST",
          headers: {
          ...
          .done(function (response) {
            ...
            if (response.statusText === 'bien') {
              ...
              $("#div_table ").html(
                ...
                "<tr>" +
                "<td><b>NUMERO</b></td>" +
                "<td><b>MODELOS DESDE</b></td>" +
                "<td><b>HASTA MODELOS</b></td>" +
                "<td><b>PRECIO</b></td>" +
