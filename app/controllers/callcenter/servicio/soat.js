export class SoatClass {
  ...
  datosRecargar() {
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url: getMyAppModel('callcenter/CallCenter', 'SoatListado'),
          type: 'POST',
          data: {
  ...
  datosSubmit() {
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url: getMyAppModel('callcenter/CallCenter', 'SoatCreate'),
          type: 'POST',
  ...
  #autoCompleteInputs() {
    myAutocomplete({
      ...
      create: true,
      input: {
        text: document.getElementById("soat-historial-ase-text"),
        hidden: document.getElementById("soat-historial-ase-select"),
      },
      table: ['id', 'nombre', 'aseguradora'],
      childs: [],
