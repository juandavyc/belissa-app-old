export class DatosClass {
  ...
  #autoCompleteInputs() {
    myAutocomplete({
      ...
      create: true,
      input: {
        text: document.getElementById("editar-correo_propietario-text"),
        hidden: document.getElementById("editar-correo_propietario-select"),
        key: false,
      },
    ...
    myAutocomplete({
      ...
      create: true,
      input: {
        text: document.getElementById("editar-correo_conductor-text"),
        hidden: document.getElementById("editar-correo_conductor-select"),
        key: false,
      },
      table: ['id', 'nombre', 'correo'],
      childs: [],
