...
export class EditarClass {
  ...
  #funcListener(_class = this) {
    ...
    myAutocomplete({
      ...
      create: true,
      input: {
        text: document.getElementById("editar-canal-mercadeo-text"),
        hidden: document.getElementById("editar-canal-mercadeo-select"),
      },
        ...
        return $.ajax({
          ...
          .done(function (response) {
            if (response.statusText === 'bien') {
              ...
              // canal
              $('#editar-canal-mercadeo-text').val(response.message.canal.nombre);
              $('#editar-canal-mercadeo-select').val(response.message.canal.id);
