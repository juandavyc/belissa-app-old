...
class PQRS
{
    ...
    public function create( 
        ...
        try {
            ...
            $mysqlStmt->bindParam(':id_asunto', $asunto, PDO::PARAM_INT);   
            $mysqlStmt->bindParam(':id_notificacion', $notificacion, PDO::PARAM_INT);   
            $mysqlStmt->bindParam(':nombre', $nombre, PDO::PARAM_STR);   
            $mysqlStmt->bindParam(':correo', $correo, PDO::PARAM_STR);
            $mysqlStmt->bindParam(':telefono', $telefono, PDO::PARAM_STR);
            $mysqlStmt->bindParam(':placa', $placa, PDO::PARAM_STR);
            $mysqlStmt->bindParam(':descripcion', $descripcion, PDO::PARAM_STR);
            ...
            if ($mysqlStmt->execute()) {                
                $this->arrayResponse = array(
                    'statusCode' => 200,
                    'statusText' => 'bien',
                    'message' => 'Enviado exitosamente, en menos de 24 Horas recibirá respuesta',
