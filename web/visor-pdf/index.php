...
$app->verificar->isAutorizado('visor-pdf', true);
$app->menu->setModulo($app->menu->getMenuArray()['visor-pdf']);
?>
<!DOCTYPE html>
<html lang="es">
...
<body data-id="visor-pdf" class="is-preload landing">
    <div id="page-wrapper">
        <article id="main">
            ...
            <?php require $app->ruta->getView('visor-pdf/Main') ?>
        </article>
    ...
    <script src="<?= $app->ruta->getController('visor-pdf/main') ?>" type="module"></script>
</body>
