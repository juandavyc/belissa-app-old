    ...
    <form id="form_agendar">
        <div class="row gtr-25 gtr-uniform">
            ...
            <div class="col-3 col-12-mobilep">
                ...
                <input type="hidden" name="id_estado" id="agendar-id_estado" value="0" data-default="0" required />
            </div>
            ...
            <div class="col-4 col-12-small">
                <div class="input-container">
                    ...
                    <div>
                        <input type="text" name="documento" id="agendar-documento" placeholder="Documento"
                            autocomplete="off">
            ...
            <div class="col-10 col-12-small">
                <div class="input-container">
                    ...
                    <div>
                        <input type="text" id="canal-mercadeo-text" value="SIN_CANAL" placeholder="Canal de mercadeo"
                            autocomplete="off">
                        <input type="hidden" name="canal" id="canal-mercadeo-select" value="1" data-default="1"
                            required="">
                    </div>
                </div>
            </div>
