<fieldset class="historial-fieldset">
    ...
    <form id="form_sms_personalizado">
        <div class="row gtr-25 gtr-uniform">
            ...
            <div class="col-9 col-12-small">
                <textarea id="sms-personalizado" name="mensaje" class="container-ckeditor" maxlength="160" DISABLED></textarea>
            </div>
            <div class="col-12">
                <fieldset class="fieldset-save">
                    ...
                    <div class="row gtr-50 gtr-uniform">
                        <div class="col-12">
                            <input type="checkbox" id="sms-terminos-condiciones" name="acepto_terminos_condiciones" DISABLED>
                        ...
                        <div class="col-6 col-12-mobilep">
                            <button type="submit" class="button primary small fit icon solid fa-save" DISABLED>
                                Guardar
                            </button>
                        </div>
                        <div class="col-6 col-12-mobilep">
                            <button type="reset" id="form_datos_vehiculo_reset" class="button primary small fit icon solid fa-undo" DISABLED>
                                Cancelar
                            </button>
                        </div>
                    </div>
