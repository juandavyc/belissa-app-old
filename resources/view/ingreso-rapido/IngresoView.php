<form id="form-ingreso" hidden>
    <div class="row gtr-50 gtr-uniform">
        <div class="col-12" hidden>
            ...
            <input type="text" name="id_vehiculo" id="ingreso-id_vehiculo" value="0" autocomplete="off">
            <label> placa vehiculo </label>
            <input type="text" name="placa" id="ingreso-placa_vehiculo" value="0" autocomplete="off">
            ...
            <label> vez </label>
            <input type="text" name="vez" id="ingreso-vez" value="0" autocomplete="off">
        </div>
        ...
        <?php require $app->ruta->getView('ingreso-rapido/Vehiculo') ?>
        <div class="col-12">
            <h3 class="icon solid fa-arrow-right h3-orange"> PRESIÓN DE LLANTAS </h3>
        </div>
        <?php require $app->ruta->getView('ingreso-rapido/Llantas') ?>
        <div class="col-12">
            <hr>
        ...
        <?php require $app->ruta->getView('ingreso-rapido/Criterios') ?>
        <div class="col-12">
        ...
        <div class="col-12">
            <?php $app->ruta->getComponent(
                'AceptoTerminos',
                array(
                    'id' => 'ingreso-acepto_responsabilidad',
