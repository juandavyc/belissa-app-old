...
<div class="col-12">
    ...
    <div class="input-container">
        ...
        <div>
            <input type="text" placeholder="2000" id="ingreso-modelo" name="modelo" inputmode="numeric" autocomplete="off">
        </div>
    </div>
</div>
<div class="col-12">
...
<div class="col-12" id="container-ingreso-carroceria" hidden>
        ...
        <div class="row gtr-25 gtr-uniform">
            <div class="col-12">
                ...
                <div class="input-container">
                    <i class="fas fa-hashtag icon-input"></i>
                    <div>
                        <input type="text" id="ingreso-certificado_gncv" name="certificado_gncv" inputmode="numeric" value="NO_APLICA" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="col-12">
                ...
                <div class="input-container">
                    ...
                    <div>
                        <div class="input-container">
                            <input type="text" id="ingreso-fecha_gncv" name="fecha_gncv" value="01/01/2000" class="input_date_listener" autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="col-12">
    ...
    <div class="input-container">
        <i class="fas fa-taxi icon-input"></i>
        <div>
            <input type="text" placeholder="2" id="ingreso-capacidad" name="capacidad" inputmode="numeric" autocomplete="off">
        </div>
    </div>
</div>
<div class="col-12" id="container-ingreso-puertas" hidden>
    <label class="label-important label-datos-alt"> Puertas</label>
    <div class="input-container">
        <i class="fas fa-taxi icon-input"></i>
        <div>
            <input type="text" placeholder="2" id="ingreso-puertas" name="puertas" inputmode="numeric" autocomplete="off">
        </div>
    </div>
</div>
<div class="col-12 align-center">
    <fieldset class="fieldset-alt">
        <legend>Enseñanza</legend>
        <label class="align-center"> ¿Es de enseñanza? </label>
    ...
    <div class="row gtr-50 gtr-uniform">
        <div class="col-12">
            ...
            <div class="input-container">
                ...
                <div>
                    <input type="text" placeholder="10001" id="ingreso-kilometraje" name="kilometraje" inputmode="numeric" autocomplete="off">
                </div>
            </div>
        </div>
        <div class="col-12">
    ...
    <div class="row gtr-25 gtr-uniform">
        <div class="col-12 align-center">
            <fieldset class="fieldset-alt">
                ...
                <label class="align-center"> Tiempos del motor</label>
        ...
        <div class="col-12 align-center">
            <fieldset class="fieldset-alt">
                ...
                <label class="align-center"> Diseño</label>
...
<div class="col-12 align-center">
    <fieldset class="fieldset-alt">
        <legend>Blindado</legend>
        <label class="align-center"> Blindado</label>
...
<div class="col-12 align-center" id="container-ingreso-polarizado" hidden>
    <fieldset class="fieldset-alt">
        <legend>Polarizado</legend>
        <label class="align-center"> Polarizado</label>
