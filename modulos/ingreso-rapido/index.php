...
$recursosApp->verificarModulo('ingreso-rapido', true);
?>
...
<head>
    <title>Ingreso rapido | Belissa CallCenter</title>
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="/modulos/app/css/ingreso-completo/style_<?=$_SESSION['session_user'][7]?>.css?v=1" />
    <noscript>
...
<body data-id="ingreso-rapido" class="is-preload landing">
    <div id="page-wrapper">
        ...
        <article id="main">
            ...
            <section class="wrapper style4 container max">
                ...
                <!-- ingreso - vehiculo -->
                <?php require DOCUMENT_ROOT . '/modulos/app/vista/ingreso-rapido/ingreso.php';?>
            </section>
    ...
    <script type="module" src="/modulos/app/controlador/ingreso-rapido/main.js?v=<?=time();?>"></script>
