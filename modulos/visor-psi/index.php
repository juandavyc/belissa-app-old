...
$recursosApp->verificarModulo('visor-psi', true);
?>
<!DOCTYPE HTML>
<html>

<head>
    <title>Visor PSI CDA | Belissa CallCenter</title>
    <meta charset="utf-8" />
...
<body data-id="Visor-Psi" class="is-preload landing">
    <div id="page-wrapper">
        <article id="main">
            <header class="special container">
                <span class="icon solid fa-solid fa-bomb"></span>
                <h2>Visor PSI CDA</h2>
            ...
            <div id="tab-visor">
                ...
                <div id="tabs-0">
                    <?php require DOCUMENT_ROOT . '/modulos/app/vista/visor-psi/buscador.php';?>
                </div>
            </div>
        </article>
    ...
    <script type="module" src="/modulos/app/controlador/visor-psi/main.js?v=<?php echo time(); ?>"> </script>
