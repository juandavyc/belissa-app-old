...
$recursosApp->verificarModulo('visor-pdf', true);
?>
<!DOCTYPE HTML>
<html>

<head>
    <title>Visor PDF CDA | Belissa CallCenter</title>
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="/modulos/app/css/visor-ingreso/style.css" />
    <noscript>
...
<body data-id="Visor-Pdf" class="is-preload landing">
    <div id="page-wrapper">
        <article id="main">
            ...
            <div id="tab-visor">
                ...
                <div id="tabs-0">
                    <?php require DOCUMENT_ROOT . '/modulos/app/vista/visor-pdf/buscador.php';?>
                </div>
            </div>
        </article>
    ...
    <script type="module" src="/modulos/app/controlador/visor-pdf/main.js?v=<?php echo time(); ?>"> </script>
