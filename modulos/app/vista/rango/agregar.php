    ...
    <div class="row gtr-25 gtr-uniform">
                ...
                <div class="row gtr-25 gtr-uniform">
                    ...
                    <div class="col-4 col-12-small">
                        <div class="input-container">
                            <i class="fas fa-align-left icon-input"></i>
                            <div>
                                <select name="tipo_conexion" id='form_1_tipo_conexion'>
                    ...
                    <div class="col-5 col-12-small align-left">
                        <button id='btn-help-conexion' class="primary small icon solid fa-question"></button>
                    </div>
                    <div class="col-12">
                        <p id="form_1_tipo_conexion_seleccionada">
        ...
        <div class="col-12">
            <fieldset>
                ...
                <div class="row gtr-25 gtr-uniform">
                    <?php $_task = 'agregar';require DOCUMENT_ROOT . '/modulos/app/vista/rango/modulos.php';?>
                </div>
            </fieldset>
        </div>
        <div class="col-12">
            <fieldset class="fieldset-save">
                ...
                <div class="row gtr-50 gtr-uniform">
                    ...
                    <div class="col-6 col-12-mobilep">
                        <button type="reset" id="btn-agregar-reset" class="button primary small fit icon solid fa-undo">
                            Cancelar
                        </button>
                    </div>
                </div>
