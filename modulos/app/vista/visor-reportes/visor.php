                ...
                <div class="row gtr-25 gtr-uniform">
                        ...
                        <div class="row gtr-25 gtr-uniform">
                            ...
                            <div class="col-3 col-12-small">
                                ...
                                <div class="input-container">
                                    ...
                                    <div>
                                        <input type="text" id="datos-usuario-text" value="SIN_USUARIO" placeholder="Usuario" autocomplete="off">
                                        <input type="hidden" name="usuario" id="datos-usuario-select" value="0" data-default="0" required="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-6 col-12-small">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="fecha_inicial" id="form_0_fecha_inicial" class="input_date_listener" value="01/01/2022" autocomplete="off" required="">
                        </div>
                    </div>
                    <div class="col-6 col-12-small">
                        ...
                        <div class="input-container">
                            <i class="fas fa-calendar icon-input"></i>
                            <input type="text" name="fecha_final" id="form_0_fecha_final" class="input_date_listener" value="01/01/2022" autocomplete="off" required="">
                        </div>
                    </div>
