<div class="row gtr-25 gtr-uniform">
    ...
    <div class="col-12">
        <fieldset>
            <legend>
                ...
                <input type="radio" id="form_0_basica" value="1" checked="">
            ...
            <form id="form_0_buscador_mensajes">
                <div class="row gtr-25 gtr-uniform">

                    <div class="col-12" id="form_0-container-buscador-avanzado">
    ...
    <div class="col-12 col-12-small" id="container-tabla-buscador">
