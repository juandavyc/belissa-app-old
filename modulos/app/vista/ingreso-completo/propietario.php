...
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        ...
        <div>
            <input type="text" placeholder="Documento" id="ingreso-propietario_documento" name="propietario_documento"
...
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        ...
        <div>
            <input type="text" placeholder="Nombres propietario" id="ingreso-propietario_nombres"
...
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        <i class="fas fa-signature icon-input"></i>
        <div>
            <input type="text" placeholder="Apellidos propietario" id="ingreso-propietario_apellidos"
...
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        ...
        <div>
            <input type="text" placeholder="000 000 0000" id="ingreso-telefono_propietario" name="propietario_telefono"
...
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        <i class="fas fa-signature icon-input"></i>
        <div>
            <input type="text" placeholder="juan.david" id="ingreso-correo_propietario" name="propietario_correo_nombre"
                value="" autocomplete="off">
        </div>
    </div>
</div>
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        ...
        <div>
            ...
            <input type="hidden" name="propietario_correo_dominio" id="ingreso-correo_propietario-select"
...
<div class="col-12">
    ...
    <div class="input-container">
        ...
        <div>
            <input type="text" placeholder="Diag 16b # 108 - 25" id="ingreso-direccion_propietario" autocomplete="off"
                name="propietario_direccion" value="">
        </div>
    </div>
</div>