<form id="form-ingreso" hidden>
    <div class="row gtr-25 gtr-uniform">
        ...
        <?php require DOCUMENT_ROOT . '/modulos/app/vista/ingreso-completo/vehiculo.php';?>
        <div class="col-12">
            <h3 class="icon solid fa-arrow-right h3-orange"> PRESIÓN DE LLANTAS </h3>
        </div>
        <?php require DOCUMENT_ROOT . '/modulos/app/vista/ingreso-completo/llantas.php';?>
        <div class="col-12">
            <hr>
        ...
        <?php require DOCUMENT_ROOT . '/modulos/app/vista/ingreso-completo/criterios.php';?>
        <div class="col-12">
            <hr>
        ...
        <?php require DOCUMENT_ROOT . '/modulos/app/vista/ingreso-completo/legal.php';?>
        <div class="col-12">
        ...
        <div class="col-12">
            <fieldset class="fieldset-save">
                ...
                <div class="row gtr-50 gtr-uniform">
                    <div class="col-12">
                        <!-- <input type="checkbox" id="form_0_tab_1_acepto_responsabilidad" name="acepto_responsabilidad" required=""> -->
