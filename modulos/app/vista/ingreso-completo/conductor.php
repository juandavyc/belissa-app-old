...
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        ...
        <div>
            <input type="text" placeholder="Documento" id="ingreso-conductor_documento" name="conductor_documento"
...
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        ...
        <div>
            <input type="text" placeholder="Nombres conductor" id="ingreso-conductor_nombres" name="conductor_nombres"
...
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        <i class="fas fa-signature icon-input"></i>
        <div>
            <input type="text" placeholder="Apellidos conductor" id="ingreso-conductor_apellidos"
...
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        ...
        <div>
            <input type="text" placeholder="000 000 0000" id="ingreso-telefono_conductor" name="conductor_telefono"
                inputmode="numeric" value="" autocomplete="off">
        </div>
    </div>
</div>
...
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        <i class="fas fa-signature icon-input"></i>
        <div>
            <input type="text" placeholder="juan.david" id="ingreso-correo_conductor" name="conductor_correo_nombre"
                value="" autocomplete="off">
        </div>
    </div>
</div>
<div class="col-6 col-12-small">
    ...
    <div class="input-container">
        ...
        <div>
            ...
            <input type="hidden" name="conductor_correo_dominio" id="ingreso-correo_conductor-select" value="gmail.com"
                data-default="gmail.com">
        </div>
    </div>
</div>