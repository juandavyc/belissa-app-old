...
class IngresoClass
{
    ...
    public function ListadoIngreso($_condicional_ = array(
        'ORDER' => 'ing.id',
        'BY' => 'DESC',
        'PAGE' => '1',
        'ROWS' => '25',
        ...
        try {
            ...
            #Columnas
            $mysqlQueryColumns .= "ing.id,ing.vez,ing.fecha_formulario, ";
    ...
    public function InfoIngreso(
        ...
        try {
            ...
            $mysqlQuery .= "veh.pasajeros,veh.kilometraje,veh.blindado,veh.polarizado, ";
            ...
            // CONDUCTOR
            $mysqlQuery .= "concat(cli.nombre,' ',cli.apellido) AS nombre_conductor,";
            ...
            // PROPIETARIO
            $mysqlQuery .= "concat(clin.nombre,' ',clin.apellido) AS nombre_propietario,";
                ...
                if (intval($mysqlStmt->rowCount()) > 0) {
                    while ($row = $mysqlStmt->fetch(PDO::FETCH_BOTH)) {
                        $mysqlArray = array(
                            ...
                            'nombre_propietario' => htmlspecialchars($row['nombre_propietario']),
                            'telefono_propietario' => htmlspecialchars($row['telefono_propietario']),
                            'correo_propietario' => htmlspecialchars($row['correo_propietario']),
    ...
    public function ListadoPsi($_condicional_ = array(
        'ORDER' => 'ing.id',
        'BY' => 'DESC',
        'PAGE' => '1',
        'ROWS' => '25',
