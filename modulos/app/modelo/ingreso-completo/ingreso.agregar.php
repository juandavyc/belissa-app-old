...
//     echo '$mysqlQuery .= '.'":'.$key.',"; <br>';
// }

// foreach ($_POST as $key => $value) {
//     echo '"'.strtoupper($key).'" => $'. $key .', <br> ';
// }
//  $mysqlQuery .= ":placa, ";
// foreach ($_POST as $key => $value) {
...
if (
    ...
    isset($_POST["politica_confidencialidad"]) &&
    isset($_POST["ofertas_comerciales"]) &&
    isset($_POST["autoriza_inspeccion"]) &&
    isset($_POST["guardar"]) &&
    ...
    $llanta_referencia = htmlspecialchars($_POST["llanta_referencia"]);
    ...
    $politica_confidencialidad = htmlspecialchars($_POST["politica_confidencialidad"]);
    $ofertas_comerciales = htmlspecialchars($_POST["ofertas_comerciales"]);
    $autoriza_inspeccion = htmlspecialchars($_POST["autoriza_inspeccion"]);
    ...
    if (
        ...
        $this->arrayResponse = $ingresoClass->CreateIngresoCom(
            array(
                ...
                "LLANTA_REFERENCIA" => $llanta_referencia,
                ...
                "POLITICA_CONFIDENCIALIDAD" => $politica_confidencialidad,
                "OFERTAS_COMERCIALES" => $ofertas_comerciales,
                "AUTORIZA_INSPECCION" => $autoriza_inspeccion,
                "GUARDAR" => $guardar,
