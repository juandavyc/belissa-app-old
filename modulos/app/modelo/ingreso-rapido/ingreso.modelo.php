...
class IngresoModelo
{
    ...
    {
        require_once DOCUMENT_ROOT . '/modulos/app/modelo/ingreso-rapido/ingreso.create.php';
    ...
    public function getDataingreso()
    {
        ...
        require_once DOCUMENT_ROOT . '/modulos/app/modelo/ingreso-rapido/ingreso.getdata.php';
        if (!empty($this->arrayResponse)) {
            $this->configuracion->petResponse($this->arrayResponse);
        }
    }
