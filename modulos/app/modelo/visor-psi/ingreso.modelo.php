...
class IngresoModelo
{
    ...
    {
        require_once DOCUMENT_ROOT . '/modulos/app/modelo/visor-psi/ingreso.listado.php';
        $this->configuracion->petResponse($this->arrayResponse);
    }
    public function Infoingreso()
    {
        require_once DOCUMENT_ROOT . '/modulos/app/modelo/visor-psi/ingreso.informacion.php';
        $this->configuracion->petResponse($this->arrayResponse);
    }
