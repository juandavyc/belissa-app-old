...
export class NotasClass {
  ...
  datosSubmit() {
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url: PROTOCOL_HOST + '/modulos/app/modelo/callcenter/rtm.modelo.php?m=NotaCreate',
          type: 'POST',
  ...
  datosEliminar(_id, _table) {
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url: PROTOCOL_HOST + '/modulos/app/modelo/callcenter/rtm.modelo.php?m=NotaDelete',
          type: 'POST',
          data: {
            id: _id,
            table: _table,
  ...
  datosPorTarea(_task = 'vehiculo') {
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url: PROTOCOL_HOST + '/modulos/app/modelo/callcenter/rtm.modelo.php?m=NotaHistorial',
          type: 'POST',
          data: {
            target: _target,
            task: _task,
