export class AgendarClass {
  ...
  datosSubmit() {
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url: PROTOCOL_HOST + '/modulos/app/modelo/agendamiento/agendamiento.modelo.php?m=Create',
          type: 'POST',
          data: _form_data,
          headers: {
  ...
  datosRecargarPlaca(_vehiculo = 1) {
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url: PROTOCOL_HOST + '/modulos/app/modelo/callcenter/rtm.modelo.php?m=VehiculoInfo',
          type: 'POST',
          data: {
            vehiculo: _vehiculo,
            rol: 'PLACA',
