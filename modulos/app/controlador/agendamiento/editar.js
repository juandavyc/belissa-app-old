...
export class EditarClass {
  ...
  datosSubmit() {
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url: PROTOCOL_HOST + '/modulos/app/modelo/agendamiento/agendamiento.modelo.php?m=Update',
          type: 'POST',
  ...
  getInformacion(_id = 1, _callback, _class = this) {
    ...
    let self = $.confirm({
      ...
      content: function () {
        return $.ajax({
          url: PROTOCOL_HOST + '/modulos/app/modelo/agendamiento/agendamiento.modelo.php?m=Info',
          type: 'POST',
          data: {
            id_elemento: _id,
          },
