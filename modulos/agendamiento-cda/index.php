...
$recursosApp->verificarModulo('agendamiento-cda', true);
?>
<!DOCTYPE HTML>
<html>

<head>
    <title>Agendamiento CDA | Belissa CallCenter</title>
    <meta charset="utf-8" />
...
<body data-id="Agendamiento-CDA" class="is-preload landing">
    <div id="page-wrapper">
        <article id="main">
            ...
            <div id="tab-visor">
                ...
                <div id="tabs-0">
                    <?php require DOCUMENT_ROOT . '/modulos/app/vista/agendamiento-cda/buscador.php';?>
                </div>
                <div id="tabs-1">
                    <?php require DOCUMENT_ROOT . '/modulos/app/vista/agendamiento-cda/agendar.php';?>
                </div>
                <div id="tabs-2">
                    <?php require DOCUMENT_ROOT . '/modulos/app/vista/agendamiento-cda/cupo.php';?>
                </div>
            </div>

            <br>
            <?php require DOCUMENT_ROOT . '/modulos/app/vista/agendamiento-cda/editar.php';?>
        </article>
    ...
    <script type="module" src="/modulos/app/controlador/agendamiento-cda/main.js?v=<?php echo time(); ?>">
    </script>
